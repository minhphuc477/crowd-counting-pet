...
MODEL_RECIPES = {
    # Test branch recipe set: only the code paths needed for
    # SHB/vgg_pet_branch_ifi_seed42_20260629_041929,
    # QNRF/vgg16_bn_qnrf_paper, and SHA/vgg16_bn_drop700_apg_lc_seed42.
    'vgg_pet_paper': {
        'backbone': 'vgg16_bn',
