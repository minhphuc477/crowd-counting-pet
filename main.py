...
# Best branch recipe set: only the code paths needed for
# SHA/vgg16_bn_apglc_density_counthead_seed42,
# SHB/vgg16_bn_apglc_branch_ifi_counthead_stage2_seed42, and
# NWPU/vgg16_bn_apglc_branch_ifi_stage1_b16_seed42.
_APGLC_BASE = {
    'backbone': 'vgg16_bn',
...
EXPERIMENTAL_MODEL_RECIPES = set()
