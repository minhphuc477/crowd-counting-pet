...
# Force-disable enhanced point-query to match baseline PET behavior
python scripts/run_backbone_seeds.py --backbone ${BACKBONE} --seeds ${SEEDS[@]} --extra_args "--epochs ${EPOCHS} --patch_size ${PATCH_SIZE} ${EXTRA_ARGS} --no-enhanced_point_query"
